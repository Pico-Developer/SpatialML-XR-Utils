...
#define XR_LIST_ENUM_XrStructureType(_) \
    ...
    _(XR_TYPE_SECURE_MR_OPERATOR_AUDIO_MICROPHONE_PICO, 1010007022) \
    _(XR_TYPE_SECURE_MR_OPERATOR_AUDIO_SPEAKER_PICO, 1010007023) \
    _(XR_TYPE_SECURE_MR_OPERATOR_LITE_RT_MODEL_PICO, 1010007024) \
    ...
    _(XR_TYPE_SPATIAL_ENTITY_PERIPHERAL_GET_INFO_PICO, 1200389031) \
    _(XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_PERIPHERAL_PICO, 1200389032) \
    _(XR_TYPE_PERIPHERAL_DATA_PICO, 1200389033) \
...
#define XR_LIST_ENUM_XrSecureMrOperatorTypePICO(_) \
    ...
    _(XR_SECURE_MR_OPERATOR_TYPE_AUDIO_MICROPHONE_PICO, 40) \
    _(XR_SECURE_MR_OPERATOR_TYPE_AUDIO_SPEAKER_PICO, 41) \
    _(XR_SECURE_MR_OPERATOR_TYPE_DEPTH_PICO, 42) \
...
#define XR_LIST_ENUM_XrSecureMrModelTypePICO(_) \
    ...
    _(XR_SECURE_MR_MODEL_TYPE_LITE_RT_MODEL_PICO, 2) \
...
#define XR_LIST_ENUM_XrSecureMrAudioFormatPcmPICO(_) \
    _(XR_SECURE_MR_AUDIO_FORMAT_PCM_16BIT_PICO, 1) \
    _(XR_SECURE_MR_AUDIO_FORMAT_PCM_32BIT_PICO, 2) \
    _(XR_SECURE_MR_AUDIO_FORMAT_PCM_FLOAT_PICO, 3) \
    _(XR_SECURE_MRAUDIO_FORMAT_PCM_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrSecureMrModelTargetPICO(_) \
    _(XR_SECURE_MR_MODEL_TARGET_NPU_PICO, 1) \
    _(XR_SECURE_MR_MODEL_TARGET_GPU_PICO, 2) \
    _(XR_SECURE_MR_MODEL_TARGET_CPU_PICO, 3) \
    _(XR_SECURE_MRMODEL_TARGET_MAX_ENUM_PICO, 0x7FFFFFFF)
...
#define XR_LIST_ENUM_XrSpatialEntityComponentTypePICO(_) \
    ...
    _(XR_SPATIAL_ENTITY_COMPONENT_TYPE_PERIPHERAL_PICO, 7) \
...
#define XR_LIST_ENUM_XrSemanticLabelPICO(_) \
    ...
    _(XR_SEMANTIC_LABEL_KEYBOARD_PICO, 25) \
    _(XR_SEMANTIC_LABEL_MOUSE_PICO, 26) \
    _(XR_SEMANTIC_LABEL_LAPTOP_PICO, 27) \
...
#define XR_LIST_ENUM_XrPeripheralBrandPICO(_) \
    _(XR_PERIPHERAL_BRAND_UNKNOWN_PICO, 0) \
    _(XR_PERIPHERAL_BRAND_PICO_PICO, 1) \
    _(XR_PERIPHERAL_BRAND_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPeripheralCategoryPICO(_) \
    _(XR_PERIPHERAL_CATEGORY_UNKNOWN_PICO, 0) \
    _(XR_PERIPHERAL_CATEGORY_UNCATEGORIZED_KEYBOARD_PICO, 1010018000) \
    _(XR_PERIPHERAL_CATEGORY_LAPTOP_KEYBOARD_PICO, 1010018001) \
    _(XR_PERIPHERAL_CATEGORY_UNCATEGORIZED_MOUSE_PICO, 1010019000) \
    _(XR_PERIPHERAL_CATEGORY_MAX_ENUM_PICO, 0x7FFFFFFF)

#define XR_LIST_ENUM_XrPeripheralModelPICO(_) \
    _(XR_PERIPHERAL_MODEL_UNKNOWN_PICO, 0) \
    _(XR_PERIPHERAL_MODEL_MAX_ENUM_PICO, 0x7FFFFFFF)
...
/// Calls your macro with the name of each member of XrSecureMrOperatorAudioMicrophonePICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorAudioMicrophonePICO(_) \
    _(type) \
    _(next) \
    _(sampleFormat) \
    _(sampleRate) \

/// Calls your macro with the name of each member of XrSecureMrOperatorAudioSpeakerPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorAudioSpeakerPICO(_) \
    _(type) \
    _(next) \
    _(sampleRate) \

/// Calls your macro with the name of each member of XrSecureMrOperatorLiteRtModelPICO, in order.
#define XR_LIST_STRUCT_XrSecureMrOperatorLiteRtModelPICO(_) \
    _(type) \
    _(next) \
    _(modelTarget) \
    _(cpuTargetNumThreads) \
...
/// Calls your macro with the name of each member of XrSpatialEntityPeripheralGetInfoPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityPeripheralGetInfoPICO(_) \
    _(type) \
    _(next) \
    _(entity) \
    _(componentType) \

/// Calls your macro with the name of each member of XrPeripheralDataPICO, in order.
#define XR_LIST_STRUCT_XrPeripheralDataPICO(_) \
    _(type) \
    _(next) \
    _(brand) \
    _(model) \
...
/// Calls your macro with the name of each member of XrSpatialEntityComponentDataPeripheralPICO, in order.
#define XR_LIST_STRUCT_XrSpatialEntityComponentDataPeripheralPICO(_) \
    _(type) \
    _(next) \
    _(data) \
...
#define XR_LIST_STRUCTURE_TYPES_CORE(_) \
    ...
    _(XrSecureMrOperatorAudioMicrophonePICO, XR_TYPE_SECURE_MR_OPERATOR_AUDIO_MICROPHONE_PICO) \
    _(XrSecureMrOperatorAudioSpeakerPICO, XR_TYPE_SECURE_MR_OPERATOR_AUDIO_SPEAKER_PICO) \
    _(XrSecureMrOperatorLiteRtModelPICO, XR_TYPE_SECURE_MR_OPERATOR_LITE_RT_MODEL_PICO) \
    ...
    _(XrSpatialEntityPeripheralGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_PERIPHERAL_GET_INFO_PICO) \
    _(XrPeripheralDataPICO, XR_TYPE_PERIPHERAL_DATA_PICO) \
    _(XrSpatialEntityComponentDataPeripheralPICO, XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_PERIPHERAL_PICO) \
