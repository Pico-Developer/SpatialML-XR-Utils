...
`CreateSecureMrProgram(...)` implementation. The shared project declaration owns
the native entrypoint, OpenXR setup, platform/graphics code, shaders, OpenXR
loader target, and `securemr_utils` sources.
