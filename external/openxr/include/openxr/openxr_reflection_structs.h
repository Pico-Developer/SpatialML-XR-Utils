...
#define _impl_XR_LIST_ALL_STRUCTURE_TYPES_CORE(_avail, _unavail) \
    ...
    _avail(XrSecureMrOperatorAudioMicrophonePICO, XR_TYPE_SECURE_MR_OPERATOR_AUDIO_MICROPHONE_PICO) \
    _avail(XrSecureMrOperatorAudioSpeakerPICO, XR_TYPE_SECURE_MR_OPERATOR_AUDIO_SPEAKER_PICO) \
    _avail(XrSecureMrOperatorLiteRtModelPICO, XR_TYPE_SECURE_MR_OPERATOR_LITE_RT_MODEL_PICO) \
    ...
    _avail(XrSpatialEntityPeripheralGetInfoPICO, XR_TYPE_SPATIAL_ENTITY_PERIPHERAL_GET_INFO_PICO) \
    _avail(XrPeripheralDataPICO, XR_TYPE_PERIPHERAL_DATA_PICO) \
    _avail(XrSpatialEntityComponentDataPeripheralPICO, XR_TYPE_SPATIAL_ENTITY_COMPONENT_DATA_PERIPHERAL_PICO) \
